...
public class SerializableRectList implements java.io.Serializable {
	...
	/**
	 * @param rects
	 *            List of rects from which to initialize instance attribute
	 *            _rects.
	 */
	...
	/**
	 * @param seq
	 *            CvSequence of rects from which to initailize instance
	 *            attribute _rects.
	 */
	...
	/**
	 * @param r
	 *            The rectangle to be added to the list of aggregated
	 *            rectangles.
	 */
	...
	/**
	 * @return List of rectangles this instance aggregates as list of CvRects.
	 */
